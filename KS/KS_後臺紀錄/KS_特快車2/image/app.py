...
if __name__=='__main__':
    ...
    try:
        while True:
            start = time.time()
            rs = requests.Session()
            url = 'https://www.kickstarter.com/login?then=%2Fprojects%2Fmoaideas%2Fmini-express-map-pack-expansion-1-and-2%2Fdashboard%3Fref%3Dcreator_nav'
            headers = {
