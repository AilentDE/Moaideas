...
if __name__=='__main__':
    ...
    try:
        while True:
            start = time.time()
            rs = requests.Session()
            url = 'https://www.kickstarter.com/login?then=%2Fprojects%2Fmoaideas%2Fboard-game-invitation-to-etariya-island%2Fdashboard%3Fref%3Dcreator_nav'
            headers = {
            ...
            data = {
                ...
                'source': 'login',
                'then': '/projects/moaideas/board-game-invitation-to-etariya-island/dashboard?ref=creator_nav',
            ...
            data = {
                ...
                "variables":{"slug":"board-game-invitation-to-etariya-island"},
            ...
            '''
            submit = []
            r = rs.get('https://www.kickstarter.com/project_referrers/refs/stats?project_id=4585330', timeout=10)
            for i in range(1, math.ceil(r.json()['total']/20)+1):
                r = rs.get('https://www.kickstarter.com/project_referrers/refs/stats?page={}&project_id=4585330'.format(i), timeout=10)
